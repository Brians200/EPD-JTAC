...
availableJtacAttacks  = [
		...
		["BOMBS", "580lb Cluster", .48, 420, "DROP_BOMBS", ["BombCluster_03_Ammo_F", 1, 212, 0.5, 10, 0, 0]],
		["BOMBS", "750lb Cluster", .52, 480, "DROP_BOMBS", ["BombCluster_01_Ammo_F", 1, 224, 0.5, 10, 0, 0]],
		["BOMBS", "1100lb Cluster", .56, 540, "DROP_BOMBS", ["BombCluster_02_Ammo_F", 1, 255, 0.5, 10, 0, 0]],
		["BOMBS", "Cruise Missile Cluster", .60, 600, "FIRE_ROCKETS", ["ammo_Missile_Cruise_01_Cluster", 1, 3911.5, -17.04, 0.1, 0.1, 0, 0]],

		["ROCKETS", "84mm MAAWS 44 HE", .30, 420, "DROP_BOMBS", ["R_MRAAWS_HE_F", 7, 295.7, 1, 15, 1, 1]],  //Special snowflake
		["ROCKETS", "Vorona 130mm HE", .40, 480, "FIRE_ROCKETS", ["M_Vorona_HE", 6, 1911.5, -28.99, 0.25, 0.25, 1, 2]],
		["ROCKETS", "230mm HE", .50, 540, "DROP_BOMBS", ["R_230mm_HE", 4, 240.55, 1, 25, .4, .2]],  //Special snowflake
		["ROCKETS", "Cruise Missile", .60, 600, "FIRE_ROCKETS", ["ammo_Missile_Cruise_01", 3, 3911.5, -17.04, 0.3, 0.3, 4, 1]],

		["GUIDEDMISSILE", "Titan AT", .50, 540, "FIRE_GUIDED_MISSILE", ["M_Titan_AT_long", "laser"]],
		["GUIDEDMISSILE", "Titan AT FnF", .60, 600, "FIRE_GUIDED_MISSILE", ["M_Titan_AT_long", "vehicle"]],
		...
		["MINES", "APERS Mix", .40, 240, "LAY_MINE_FIELD", [["APERSMine", "APERSBoundingMine"], 20, 20]],
		["MINES", "Anti-Tank Mine", .30, 300, "LAY_MINE_FIELD", [["ATMine"], 20, 20]],
		...
		["NONLETHAL", "White Wall Large", .14, 60, "EVEN_SPREAD_PROJECTILES", [["Smoke_120mm_AMOS_White"], 35, -80, 1000]],
		["NONLETHAL", "Flare Cloud", .10, 30, "EVEN_SPREAD_PROJECTILES", [["F_40mm_White", "F_40mm_Green", "F_40mm_Red", "F_40mm_Yellow"], 35, -0.1, 120]],
		["NONLETHAL", "Chem Lights", .10, 30, "EVEN_SPREAD_PROJECTILES", [["Chemlight_blue", "Chemlight_red", "Chemlight_yellow", "Chemlight_green"], 10, -0.1, 120]],
		["NONLETHAL", "Strobes", .10, 30, "EVEN_SPREAD_PROJECTILES", [["I_IRStrobe"], 15, -0.1, 120]],
		["NONLETHAL", "Night Signal", .10, 30, "EVEN_SPREAD_PROJECTILES", [["Chemlight_blue", "G_40mm_Smoke"], 8, -0.1, 120]]
	];
